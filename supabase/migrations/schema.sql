...
-- Profiles con coordenadas geográficas (CDMX - zonas principales)
INSERT INTO profiles (id, name, age, avatar, bio, is_verified, trust_score, location, latitude, longitude, budget_min, budget_max, joined_date) VALUES
  ('user-1', 'María García', 28, 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&h=400&fit=crop', 'Diseñadora UX trabajando remoto. Busco un espacio tranquilo y luminoso. Me encanta cocinar los fines de semana y salir a correr por las mañanas.', true, 92, 'Condesa, CDMX', 19.4111, -99.1733, 8000, 12000, '2024-01-15'),
  ('user-2', 'Carlos Mendoza', 32, 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop', 'Ingeniero de software. Trabajo híbrido, 3 días en oficina. Busco roomie responsable y que le guste mantener el orden.', true, 88, 'Del Valle, CDMX', 19.3895, -99.1686, 7000, 10000, '2023-11-20'),
  ('user-3', 'Ana Rodríguez', 25, 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=400&fit=crop', 'Estudiante de maestría en la UNAM. Busco departamento cerca del campus. Soy tranquila pero me gusta organizar cenas con amigos de vez en cuando.', false, 75, 'Coyoacán, CDMX', 19.3467, -99.1617, 5000, 8000, '2024-02-10'),
  ('user-4', 'Diego López', 30, 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=400&fit=crop', 'Músico profesional y profesor de guitarra. Tengo estudio en casa pero uso audífonos siempre. Busco lugar con buena vibra.', true, 85, 'Roma Norte, CDMX', 19.4195, -99.1619, 6000, 9000, '2023-09-05'),
  ('user-5', 'Sofía Hernández', 27, 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&h=400&fit=crop', 'Abogada en firma corporativa. Horarios largos pero ordenada. Busco roomie responsable con quien compartir gastos de un buen depa.', true, 95, 'Polanco, CDMX', 19.4320, -99.1937, 10000, 15000, '2024-03-01'),
  ('user-6', 'Roberto Sánchez', 35, 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=400&fit=crop', 'Emprendedor con startup de tecnología. Tengo 2 propiedades disponibles para rentar habitaciones. Busco roomies profesionales.', true, 90, 'Santa Fe, CDMX', 19.3595, -99.2614, 0, 0, '2023-06-15');
